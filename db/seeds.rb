...
ActivityPoint.create!(
  [
    {time: '13:00',date: '2022/5/10', person: '1',spot: 'スカイツリー',prefecture: '東京都',address: '墨田区押上1丁目1-2',activity_status: 0,request: 'スカイツリー周辺散策予定です。写真を撮る練習がしたいです！', user_id: 1 },
    {time: '13:30',date: '2022/5/10', person: '3',spot: '浅草寺雷門',prefecture: '東京都',address: '台東区浅草2丁目3-1',activity_status: 1,request: '東京旅行中です。浅草で友達と写真撮って欲しいです', user_id: 2 },
    {time: '15:00',date: '2022/5/12', person: '1',spot: '東京駅',prefecture: '東京都',address: '千代田区丸の内1丁目',activity_status: 0,request: '東京駅で写真撮って欲しい方いませんか？', user_id: 3 },
    {time: '10:00',date: '2022/5/5', person: '3',spot: 'あべのハルカス',prefecture: '大阪府',address: '大阪市阿倍野区阿倍野筋1丁目1-43',activity_status: 0,request: '天王寺周辺でフォトウォーク中です！写真撮って欲しい方はぜひ！', user_id: 4 },
    {time: '11:30',date: '2022/5/5', person: '2',spot: '通天閣',prefecture: '大阪府',address: '大阪市浪速区恵美須東1丁目18-6',activity_status: 1,request: '旅行中です！ペットと一緒に撮っていただけませんか', user_id: 5 },
    {time: '14:00',date: '2022/5/10', person: '4',spot: '天王寺動物園',prefecture: '大阪府',address: '大阪市天王寺区茶臼山町1-108',activity_status: 1,request: '家族で動物園にいきます！家族写真が撮りたいです', user_id: 6 }
  ]
)
